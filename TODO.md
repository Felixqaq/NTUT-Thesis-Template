...
- [x] 把RQ1 量化特徵二分類結果的表跟圖都移到RQ1最後面
---------------------------------------------------------------------------------------------------------------

- [x] RQ2直接幫我顯示最強的模型結果就好 不用抓四個顯示
...
- [x] ![alt text](<截圖 2026-05-28 下午5.19.08.png>) 解釋pooled 跟baseline是怎樣 還有把排名移除 前面的表 4.6跟 後面的表 4.9 也移除排名


---------------------------------------------------------------------------------------------------------------

- [x] 4.3.4 裡面不要再分小節了 然後再幫我先展示二分類然後再說三分類
