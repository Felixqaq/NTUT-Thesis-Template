...
\includepdf[pages=-,offset=0 -1in]{figures/口委審定書.pdf}
...
% 章節四 Chapter 4
\include{chapter/chapter4-results.tex}
% 章節五 Chapter 5
...
\appendix
% 附錄章名改為「附錄 A」樣式（避免沿用本文「第 X 章」之中文數字格式）
\renewcommand\prechaptername{附錄\ }
\renewcommand\postchaptername{}
\renewcommand\tocprechaptername{附錄\ }
